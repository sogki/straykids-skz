/** Internal routes for banner / admin link pickers. */
export const SITE_INTERNAL_LINKS = [
  ...
  { label: 'Fan Profile Maker', path: '/fan-profile' },
  { label: 'Bias Quiz', path: '/bias-quiz' },
  { label: 'Games section (home)', path: '/#games' },
]
