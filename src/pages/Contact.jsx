  ...
  return (
    <article className="legal-page">
      ...
      <p className="legal-page__lead">
        Report incorrect puzzle data, request a takedown, or ask a privacy question. Submissions
        go to the site team and appear in our admin inbox.
      </p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            See also <Link to="/terms">Terms</Link> and <Link to="/privacy">Privacy</Link>.
          </li>
        </ul>
      </section>
